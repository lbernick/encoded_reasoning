...
<answer>42</answer>"""
        assert grade_output_in_tags(text, "42") == 1.0
...
<answer>100</answer>"""
        assert grade_output_in_tags(text, "100") == 1.0
...
<answer>42</answer>"""
    ...
    def test_emoji_reasoning_wrong_answer(self):
        ...
        text = """<reasoning>🌼🌸 ➡️💜💜💜</reasoning>
<answer>42</answer>"""
        assert grade_output_in_tags(text, "43") == 0.0
...
<answer>42</answer>"""
        assert grade_output_in_tags(text, "42") == 0.0
...
<answer>50</answer>"""
        assert grade_output_in_tags(text, "50") == 1.0
...
<answer>50</answer>"""
    ...
    def test_reasoning_with_ascii_operators(self):
        ...
        text = """<reasoning>🌼🌸 + 🌸💜 = 🔛💐</reasoning>
<answer>50</answer>"""
        assert grade_output_in_tags(text, "50") == 0.0
